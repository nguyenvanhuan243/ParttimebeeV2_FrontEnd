...
const PolicyPage = () => (
  <div>
    ...
    <div className="PolicyPage-container">
      <div className="PolicyPage-privacy"> Privacy </div>
      <div className="PolicyPage-contentContainer">
        <div className="PolicyPage-sectionContainer">
          ...
          <div className="Policy-session2"> What does this Privacy Policy cover? </div>
          ...
          <div className="Policy-session4"> Will Product Hunt ever change this Privacy Policy? </div>
